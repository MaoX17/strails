...
class NewEvaluate extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        //->from('noreply@strails.it')
        ->subject('Strails - Nuova segnalazione su sentiero preferito')
                    ->line('Nuova segnalazione sul sentiero '.$this->evaluable->getName())
                    //->action('Notification Action', url('/'))
                    //->action('Clicca qui per vedere la segnalazione',route('viewRelationMap', ['relid' => $this->evaluable->id]))
                    ->action('Clicca qui per vedere la segnalazione',$url)
                    ->line('Grazie per aver usato la nostra app!');
    }

...
trait UserAttribute
{
    ...
    {
        return config('strails.access.users.change_email');
    }
    ...
    {
        return ! app('session')->has(config('strails.access.socialite_session_name'));
    }
    ...
    {
        return config('strails.access.users.requires_approval') && $this->confirmed == 0;
    }
    ...
    public function getFullNameAttribute2()
    {
    ...
    {
        if (! $this->isConfirmed() && ! config('strails.access.users.requires_approval')) {

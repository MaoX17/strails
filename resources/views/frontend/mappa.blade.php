...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="loader" id="loader">
            <img src="{{secure_asset('img/ajax-loader.gif')}}" height="42">
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a class="btn btn-primary" href="{{route('auth.login')}}">Login</a> @endif
...
@if (isset($logged_in_user->token_strava_access))
    <script async src="{{secure_asset('js/ajax_mappa.js')}}"></script>
@else
    <script async src="{{secure_asset('js/ajax_mappa_nostrava.js')}}"></script>
@endif

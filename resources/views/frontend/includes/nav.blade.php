<nav class="navbar navbar-default">
    <div class="container">
        ...
        <!-- <h1 style="text-align: left; float: left; display: inline;">{{ link_to_route('frontend.index', app_name(), [], ['class' => 'navbar-brand']) }}</h1> -->
        <!-- <h2 style="font-size: 15px; text-align: right; float: right; display: inline;"><small>{{ link_to_route('frontend.index', env('APP_NAME2'), [], ['class' => 'navbar-brand']) }}</small></h2> -->

...
<script async src='{{asset('js/notifiche.js')}}' type="text/javascript" charset="utf-8"></script>
    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-5 col-xs-4 col-xs-offset-4">
            <a href="{{ route('frontend.index_home') }}" class="thumbnail" title="Strails">
                <img src="{{ asset('img/logo/logo468_t.png') }}" alt="Logo">
            </a>
        </div>
    </div>
    ...
    <div class="row">
            ...
            <div class="col-md-3 col-xs-10 col-xs-offset-1 centered">
                <a href="{{ route('strava.getauthorization') }}" title="E' necessario aver fatto login">
                    <img src="{{asset('img/btn_strava_connectwith_light.png')}}" alt="Strava Logo">
                </a>
            </div>
            @endif
        ...
        <div class="row">
            ...
            <h4>Segmenti preferiti presi da Strava:</h4>
                @foreach ($starred as $item)
                    ...
                    <div class="col-xs-12 col-md-4 text-center">
                        <a href="{{route('viewSegmentMap', ['relid' => $item->id]) }}" class="btn btn-sm btn-info" aria-label="Left Align"

...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta property="og:image" content="{{ asset('img/logo/logo468_t.png') }}" />
        ...
        <meta name="twitter:image" content="{{ asset('img/logo/logo468_t.png') }}" />
...
<footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
        <a href="http://www.maurizio.proietti.name" rel="noreferrer" target="_blank" title="Strails Author">Maurizio Proietti</a>
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; {{ date('Y') }} <a href="#" title="Strails">{{ app_name() }}</a>.</strong> {{ trans('strings.backend.general.all_rights_reserved')}}

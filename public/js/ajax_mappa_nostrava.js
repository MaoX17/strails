$(document).ready(function () {
    ...
    var tiles = L.tileLayer(
            "https://{s}.tile.thunderforest.com/cycle/{z}/{x}/{y}{r}.png?apikey=73ccde1305884f6ca1a059aa28670fe8",
            {
                maxZoom: 18,
                attribution:
    ...
    var url =
        "https://" + window.location.hostname + "/storage/full_0_100.json";
    //var url_pt = "https://" + window.location.hostname + "/rel/node3/" + item.value;
    var url_pt =
        "https://" + window.location.hostname + "/storage/full_0_100_pt.json";
            ...
            pointToLayer: function (feature, latlng) {
                ...
                marker.bindPopup(
                    "Nome: " +
                        ...
                        "<br/>" +
                        "Fai doppio click qui per aprire il sentiero." +
                        '<br/> <a href="https://' +
                        window.location.hostname +
                        "/eval/new/" +
                        feature.properties.rel_id +
                        '/Relation"> Commenta... </a>' +
                        '<br/> <a href="https://' +
                        window.location.hostname +
                        "/relationView/" +
